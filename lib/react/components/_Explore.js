  ...
  _createClass(Explore, [{
    ...
    value: function _handleRequestContent() {
      ...
      if (requestOptions.length > 0) {
        request('GET', requestOptions, { tag: label ? label + '-explore' : 'explore' });
      }
    }
  }, {
...
exports.default = (0, _reactRedux.connect)(null, { request: _transactionsReduxRequest.request })(Explore);