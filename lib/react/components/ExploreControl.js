...
var Search = function Search(_ref) {
  ...
  return _react2.default.createElement(
    ...
    isAdd && _react2.default.createElement(_transactionsInterfaceWeb.IconButton, {
    ...
    _react2.default.createElement(_transactionsInterfaceWeb.IconButton, {
      className: (0, _classnames2.default)('button icon-button button--alive search__button', {
        'search__button--small': isSmall
      }),
...
exports.default = (0, _transactionsCmsState.Search)(Search);