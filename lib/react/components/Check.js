  ...
  _createClass(Check, [{
    ...
    value: function componentWillMount() {
      var _props = this.props,
          id = _props.id,
          setSubmitId = _props.setSubmitId;
...
var mapStateToProps = function mapStateToProps(state, _ref2) {
  ...
  var cardViewer = state.cardViewer,
      ...
      isNew = state.submit.isNew;

  var ContentComponent = entityName && cardViewer[entityName];
  var slugEntities = collectionName && reselect(state, 'WITH_SLUG', collectionName);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, { assignPipeline: _transactionsCmsState.assignPipeline,
  ...
  setSubmitId: _transactionsCmsState.setSubmitId
})(Check);