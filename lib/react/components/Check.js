  ...
  _createClass(Check, [{
    ...
    value: function _handleNavigation() {
      var _props = this.props,
          ...
          pipelineEntitiesLength = _props.pipelineEntitiesLength,
      ...
      if (collectionName) {
        if (!slug) {
          ...
          if (!pipelineEntitiesLength && !hasRequestedOnce) {
            ...
            requestTransactions('GET', [{ collectionName: collectionName }], collectionName + '-check');
            return;
          }
          ...
          if (!entity) {
            if (!hasRequestedOnce) {
              ...
              if (!isNew || newEntity) {
                this.setState({ hasRequestedOnce: true });
                requestTransactions('GET', [{ collectionName: collectionName, query: { slug: slug } }], collectionName);
              }
            }
