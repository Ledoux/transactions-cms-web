...
var Card = function (_Component) {
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      var isControl = (ChildComponent.WrappedComponent || ChildComponent).defaultProps.isControl;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(ChildComponent, _extends({}, entity, transactionsProps))
      );
    }
  }]);
...
function mapStateToProps(state, ownProps) {
  ...
  var newForm = (0, _transactionsCmsState.getNewForm)();
  var notStoredOptions = newForm && (0, _transactionsReduxNormalizer.getNotStoredOptions)(state, newForm, { appSchema: appSchema });
