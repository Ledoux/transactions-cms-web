...
var RadiosForm = function RadiosForm(props) {
  var evaluationId = props.evaluationId,
      ...
      state = props.state,
      title = props.title;
  var maxEvaluationValue = state.maxEvaluationValue;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      entities && entities.map(function (_ref, index) {
        ...
        var isMax = value === maxEvaluationValue;
        var isSelected = id === evaluationId;
